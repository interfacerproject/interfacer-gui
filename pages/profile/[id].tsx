...
const Profile: NextPage = () => {
  ...
  const filter = {
    primaryIntentsResourceInventoriedAsPrimaryAccountable: idToBeFetch,
  };
  if (conformTo) {
    // @ts-ignore
      ...
      {user && (
        <>
          <div className="grid grid-cols-1 px-2 pt-8 md:grid-cols-2 md:pl-8">
            ...
            <div className="flex flex-col">
              <div className="w-full p-4 mx-auto border-2 rounded h-60 md:w-4/5">
                <h2>{t("your stats")}:</h2>
            ...
            <div id="tabs" className="my-6 space-x-4">
              ...
              <span className="invisible rounded-lg btn btn-disabled lg:visible">Saved list</span>
            </div>
          </div>
